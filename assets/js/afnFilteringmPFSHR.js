...
jQuery.fn.dataTableExt.afnFiltering.push(
  function( oSettings, aData, iDataIndex ) {
    ...
    var iRangeYear = document.getElementById('rangemPFSHR').value *1;


    var iTypeYear = document.getElementById('typemPFSHR').value;


    var colValue;
    if (aData[16] !== undefined){
      colValue = parseFloat(aData[16]);
    }else {
      colValue = 0;
    }

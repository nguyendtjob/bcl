...
jQuery.fn.dataTableExt.afnFiltering.push(
  function( oSettings, aData, iDataIndex ) {
    ...
    var iRangeYear = document.getElementById('rangemPFScomp').value *1;


    var iTypeYear = document.getElementById('typemPFScomp').value;


    var colValue;
    if (aData[15] !== undefined){
      colValue = parseFloat(aData[15]);
    }else {
      colValue = 0;
    }

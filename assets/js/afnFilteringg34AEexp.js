...
jQuery.fn.dataTableExt.afnFiltering.push(
  function( oSettings, aData, iDataIndex ) {
    ...
    var iRangeYear = document.getElementById('rangeg34AEexp').value *1;


    var iTypeYear = document.getElementById('typeg34AEexp').value;


    var colValue;
    if (aData[22] !== undefined){
      colValue = parseFloat(aData[22]);
    }else {
      colValue = 0;
    }

...
jQuery.fn.dataTableExt.afnFiltering.push(
  function( oSettings, aData, iDataIndex ) {
    ...
    var iRangeYear = document.getElementById('rangemPFSexp').value *1;


    var iTypeYear = document.getElementById('typemPFSexp').value;


    var colValue;
    if (aData[14] !== undefined){
      colValue = parseFloat(aData[14]);
    }else {
      colValue = 0;
    }

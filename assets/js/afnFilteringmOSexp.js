...
jQuery.fn.dataTableExt.afnFiltering.push(
  function( oSettings, aData, iDataIndex ) {
    ...
    var iRangeYear = document.getElementById('rangemOSexp').value *1;


    var iTypeYear = document.getElementById('typemOSexp').value;


    var colValue;
    if (aData[18] !== undefined){
      colValue = parseFloat(aData[18]);
    }else {
      colValue = 0;
    }

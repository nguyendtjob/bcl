...
jQuery.fn.dataTableExt.afnFiltering.push(
  function( oSettings, aData, iDataIndex ) {
    ...
    var iRangeYear = document.getElementById('rangeg34AEcomp').value *1;


    var iTypeYear = document.getElementById('typeg34AEcomp').value;


    var colValue;
    if (aData[23] !== undefined){
      colValue = parseFloat(aData[23]);
    }else {
      colValue = 0;
    }
